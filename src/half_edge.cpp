...
HalfEdgeMesh::HalfEdgeMesh(const char *const path)
{
  ...
  Vector3dTripleFunc HashFunc3 = bind(HashFunc<Vector3d, 3>, placeholders::_1);
  Vector3dTwoTripleFunc EqualKey3 = bind(EqualKey<Vector3d, 3>, placeholders::_1, placeholders::_2);
  ...
  Vector2dPairFunc HashFunc2 = bind(HashFunc<Vector2st, 2>, placeholders::_1);
  Vector2dTwoPairFunc EqualKey2 = bind(EqualKey<Vector2st, 2>, placeholders::_1, placeholders::_2);
...
{
  ArrayPairFunc UnorderedHashFuncPair = bind(UnorderedHashFunc<array<size_t, 2>, 2>, placeholders::_1);
  ArrayTwoPairFunc UnorderedEqualKeyPair = bind(UnorderedEqualKey<array<size_t, 2>, 2>, placeholders::_1, placeholders::_2);
